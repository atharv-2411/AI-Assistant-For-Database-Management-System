...
import { Menu, X, Database, Zap, Shield, ArrowRight, Github, Twitter, Linkedin, LogOut, User, Lock, Eye, EyeOff } from 'lucide-react';

// ✅ FIX: Move LoginModal OUTSIDE the main component to prevent re-creation [web:129]
...
export default function HomePage() {
  const projectId = "1234"; // ✅ FIX: Add back projectId for redirect
  ...
  const handleSubmit = useCallback((e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isSignUp) {
      ...
      if (user) {
        ...
        // ✅ FIX: Redirect after successful login
        setTimeout(() => {
          window.location.href = `/in/${projectId}`;
        }, 500);
  ...
  const handleGetStarted = useCallback(() => {
    if (currentUser) {
      // ✅ FIX: Direct redirect for logged-in users
      window.location.href = `/in/${projectId}`;
    } else {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      {/* ✅ FIX: LoginModal moved outside with stable props */}
      <LoginModal
      ...
      <div className="absolute inset-0 z-30 flex flex-col">
        {/* Navigation */}
        <nav className="relative z-40 bg-black/20 backdrop-blur-md border-b border-white/10">
              ...
              <div className="hidden md:flex items-center space-x-4">
                {currentUser ? (
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-full text-sm font-medium hover:shadow-lg transition-all duration-300"
                  >
                    Get Started
                  </button>
                )}
          ...
          {mobileMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black/30 backdrop-blur-md">
                ...
                <button
                  onClick={handleGetStarted}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white block px-3 py-2 rounded-md text-base font-medium w-full text-left"
                >
                  Get Started
                </button>
              </div>
          ...
          <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button
                  onClick={handleGetStarted}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full text-lg font-medium hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Discover the tools that make database management effortless and efficient
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="bg-gradient-to-r from-purple-600 to-pink-600 w-12 h-12 rounded-full flex items-center justify-center mb-6">
